    ...
    <div className="container">
      <div className="card" style={{ maxWidth: '400px', margin: '0 auto', marginTop: '2rem' }}>
        ...
        <form onSubmit={handleSubmit(onSubmit)} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          <div>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }} htmlFor="username">
              Username
            </label>
            <input
              {...register('username')}
          ...
          <button
            ...
            style={{ 
              width: '100%',
              opacity: (isSubmitting || registerMutation.isPending) ? '0.5' : '1',
          ...
          <div style={{ textAlign: 'center' }}>
            <span style={{ fontSize: '0.875rem', opacity: '0.7' }}>
              ...
              <a href="/login" style={{ color: '#ffffff', fontWeight: '500', textDecoration: 'underline' }}>
                Sign in here
              </a>
            </span>
          </div>
